...
function App() {
  ...
  const handleSearch = (query) => {
    if (query.trim() === "") {
      ...
      const filteredData = initial_data.filter((country) =>
  ...
  return (
    <Router>
      ...
      <div style={{boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.25)", padding:"50px", textAlign:"center", borderRadius:"30px", margin:"50px"}}>
        <h1>Country Search</h1>
        <SearchBar onSearch={handleSearch} />
        <div style={{textAlign:"left", paddingLeft:"40%", paddingRight:"33%", marginTop:"30px"}}>
        <label style={{ listStyleType: "none" }}>
          {searchResults.map((country) => (
            <li key={country.country}>
              ...
              >
                < CiSearch style={{paddingRight:"20px"}}/>
